...
> [!NOTE]
> 欢迎使用版本0.4.1，当前版本修复了自动检查更新的功能的一些问题，加入了两个AI新技能，重构了访问AI的代码结构。见[本次更新](#本次更新)
...
- [GamesAI](#gamesai)
  ...
  - [本次更新](#本次更新)
    - [1.修复了自动检查更新的问题](#1修复了自动检查更新的问题)
    - [2.加入了两个新技能](#2加入了两个新技能)
  - [鸣谢与声明](#鸣谢与声明)
  - [许可证](#许可证)
...
### 2.加入了两个新技能
加入了 添加/移除 白名单的技能，并且为之后添加自定义 skill 做了代码基础
