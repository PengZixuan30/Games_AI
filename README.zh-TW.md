...
[回報問題](https://github.com/PengZixuan30/Games_AI/issues/new)  |  [提供想法](https://github.com/PengZixuan30/Games_AI/issues/new)

</div>

> [!NOTE]
> 歡迎使用版本 0.5.0！此版本加入了自訂工具功能，加入了多個新工具，並修正了一些問題。詳見[本次更新](#本次更新)

> [!IMPORTANT]
> 此版本加入了自訂工具功能，會在設定資料夾中建立 `tools.py` 檔案。詳見[自訂工具](#自訂工具)
...
### 1. 加入了自訂工具功能
本次更新加入了自訂工具功能，讓你擁有更多元的體驗。設定方法請見[自訂工具](#自訂工具)。

### 2. 加入了新的工具
加入了新的工具，主要包含計算機類和座標管理類。
